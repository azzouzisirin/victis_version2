...
<section className="contact  text-light bg-dark-to-grey pt-8 pb-12 md:py-17" id="footer-contact">
	<div className="max-w-grid mx-auto px-4 grid:px-0">
		...
		<div className="mt-8 md:mt-14 xs-lg:max-w-564p lg:flex mx-auto text-dark">
							<a className="inline-flex flex-1 lg:flex lg:flex-col items-center p-5 lg:px-8 lg:py-13 lg:text-center w-full text-link18 lg:text-h4 font-semibold colorcontact  drift-open-chat" href="#" target="">
	...
	<svg className="ml-2 h-6 w-6  stroke-current " fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 25">
		...
		<path className="stroke-current" d="M15 5.5l7 7-7 7" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="square"/>
							...
							<a className="inline-flex flex-1 lg:flex lg:flex-col items-center p-5 lg:px-8 lg:py-13 lg:text-center w-full text-link18 lg:text-h4 font-semibold colorcontact " href="/contact-us/" target="">
	...
	<svg className="ml-2 h-6 w-6  stroke-current " fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 25">
		...
		<path className="stroke-current" d="M15 5.5l7 7-7 7" strokeWidth="2" strokeMiterlimit="10" strokeLinecap="square"/>
							...
							<a className="inline-flex flex-1 lg:flex lg:flex-col items-center p-5 lg:px-8 lg:py-13 lg:text-center w-full text-link18 lg:text-h4 font-semibold colorcontact " href="tel:+33 (0)9 63 22 47 40" target="">
