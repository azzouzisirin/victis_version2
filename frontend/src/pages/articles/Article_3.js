...
export default function Article_3() {
    ...
    return ( 
        <> 
        <NavBar/>
<div class="post-template-default single single-post postid-53567 single-format-standard wp-embed-responsive theme-pyxl-scry woocommerce-js" data-template="base.twig">
		...
		<article class="post-single post-type-post max-w-5xl px-5 mx-auto" id="post-53567">
			<header class="pt-1 text-center">
                <div class="font-semibold uppercase text-grey-2 text-o18">
                                            ...
                                            <a href="" class="ease-200 hover:text-grey-3">CHEVILLE,</a>
                                            <a href="" class="ease-200 hover:text-grey-3">Simulation</a>
                                    </div>				
                <h1 class="py-6 article-h1 accent-b">VICTIS teste les implants Alevio Spine via SOLIDWORKS Simulation</h1>
            ...
            <img class="mt-7" height="472" src="./img/Template--984x472-c-default.png"/>
