...
<p> cliquez ici</p> 
   ...
   {TypeModel=="1"? <div class="product-template-default single single-product postid-8959 wp-embed-responsive theme-pyxl-scry woocommerce woocommerce-page woocommerce-js" data-template="base.twig">
		...
		<div class="mdc-tab-scroller__scroll-area mdc-tab-scroller__scroll-area--scroll" style={{marginBottom: "0px"}}>
			...
			<button className={isShown==1 ?"mdc-tab px-0 mr-18 flex-grow-0 mdc-tab--active":"mdc-tab px-0 mr-18 flex-grow-0"}   onClick={()=>setIsShown(1)} role="tab" aria-selected="false" tabindex="1"  id="mdc-tab-2">
						<span class="mdc-tab__content" >
							<span class="mdc-tab__text-label ">Nos formations </span>
						</span>
						...
						<span class="mdc-tab__content">
							<span class="mdc-tab__text-label " >Localiser nos formations</span>
						</span>
						{isShown==3	?	<span class="mdc-tab-indicator mdc-tab-indicator--active">
							<span class="mdc-tab-indicator__content mdc-tab-indicator__content--underline"></span>
						</span> :null}
						<span class="mdc-tab__ripple mdc-ripple-upgraded"></span>
					</button>
...
{isShown==3?	<div class="opacity-0 h-0  o:opacity-100 o:h-auto divVisible " >
