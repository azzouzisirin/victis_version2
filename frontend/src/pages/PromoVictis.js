...
<p><strong><font  style={{verticalAlign: "inherit"}}><font  style={{verticalAlign: "inherit"}}>Caractéristiques:&nbsp;</font></font></strong></p>
<ul>
<li><strong><font  style={{verticalAlign: "inherit"}}><font  style={{verticalAlign: "inherit"}}>Portable</font></font></strong><font  style={{verticalAlign: "inherit"}}><font  style={{verticalAlign: "inherit"}}> – processeur intégré puissant et batterie intégrée.&nbsp;</font></font></li>
<li><strong><font  style={{verticalAlign: "inherit"}}><font  style={{verticalAlign: "inherit"}}>Interface tactile facile à utiliser</font></font></strong><font  style={{verticalAlign: "inherit"}}><font  style={{verticalAlign: "inherit"}}> - le Leo dispose d'un écran tactile intégré et d'une interface simple.&nbsp;</font></font></li>
<li><strong><font  style={{verticalAlign: "inherit"}}><font  style={{verticalAlign: "inherit"}}>Connecté -&nbsp;</font></font></strong><font  style={{verticalAlign: "inherit"}}><font  style={{verticalAlign: "inherit"}}> Connexion WI-FI et batterie intégrée offrant une véritable liberté de numérisation 3D.&nbsp;</font></font></li>
...
<ul>
<li><strong><font  style={{verticalAlign: "inherit"}}><font  style={{verticalAlign: "inherit"}}>La mise à niveau est facile -</font></font></strong><font  style={{verticalAlign: "inherit"}}><font  style={{verticalAlign: "inherit"}}> contactez-nous et nous vous enverrons une étiquette d'expédition, afin que vous puissiez nous envoyer votre scanner 3D indésirable.&nbsp;</font></font></li>
<li><strong>N'IMPORTE QUEL scanner 3D</strong> – tant que vous êtes le propriétaire et non un revendeur. Ne vous inquiétez pas de la technologie, du fabricant ou de l'âge, nous le prendrons!&nbsp;</li>
</ul>
<p style={{textAlign: "left"}}><strong>Il est maintenant temps de mettre à jour vos capacités de numérisation 3D. Remplissez le formulaire ci-dessous et un représentant des ventes VICTIS vous contactera sous peu !</strong></p>
<h5>Termes et conditions:</h5>
<h6><em>*Un seul rabais peut être appliqué par Leo. L'offre comprend les forfaits Leo, Leo Education et Leo Premium. </em><em>Packs non inclus. Sous réserve de modifications, la promotion est valable jusqu'au 30 juin 2023.</em></h6>
